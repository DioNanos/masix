...
[![Status](https://img.shields.io/badge/Status-0.3.8-blue.svg)](#project-status)
...
- Telegram streaming modes (`telegram_edit` / `telegram_chunked`) with scoped runtime enforcement
