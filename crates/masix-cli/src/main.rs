...
enum PluginCommands {
    ...
    /// Install a plugin package from local .pkg file (no server required)
    InstallFile {
        /// Path to local plugin .pkg file
        #[arg(long)]
        file: String,
        /// Plugin id (e.g. discovery)
        #[arg(long)]
        plugin: String,
        /// Installed version label (default: local)
        #[arg(short, long)]
        version: Option<String>,
        /// Package type (default: mcp_binary)
        #[arg(long)]
        package_type: Option<String>,
        /// Optional entrypoint metadata
        #[arg(long)]
    ...
    json!({
        ...
        "commands": [
            ...
            },
            {
                ...
                "command": "masix plugin install-file --file <path.pkg> --plugin <id> [--version <v>] [--package-type <type>] [--entrypoint <bin>] [--platform <id>]",
                "scope": "modules",
                "interactive": false,
                "purpose": "Install module package from local file (offline/no server)"
            },
            {
                "id": "plugin.update",
