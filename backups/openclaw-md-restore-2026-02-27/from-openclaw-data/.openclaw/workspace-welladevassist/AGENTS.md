...
12. Non inviare mai errori tecnici o di sistema al cliente su Telegram; registra solo errori interni/log e mantieni risposta cliente pulita.
...
- In modalita' `user` (tutti gli altri DM):
  ...
  - non usare tool in autonomia (raccolta conversazionale; verifiche CRM solo lato admin)
...
- Nessuna notifica automatica tra bot/canali attiva in questa fase.
