...
## Identita' e accessi
- Owner/admin trusted: Telegram `836964045` / `@D10N4n0s` (DAG), fallback `+393471443005`.
...
- Nessun messaggio automatico su Telegram verso owner/admin.
- Notifiche e alert operativi solo su Telegram DM owner.
- Nessuna ricerca web nel canale Telegram clienti.
...
- Salva origine lead quando disponibile (es. `wellanet.dev`, referral, diretto Telegram).
