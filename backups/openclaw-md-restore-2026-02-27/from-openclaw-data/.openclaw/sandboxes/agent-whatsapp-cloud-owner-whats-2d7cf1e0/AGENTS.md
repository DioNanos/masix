...
4. Se l'ultimo contatto utile supera 72 ore, chiedi un nuovo messaggio di riattivazione e mantieni risposta minima.
...
12. Non inviare mai errori tecnici o di sistema al cliente su WhatsApp; instrada gli errori solo al DM Telegram dell'owner.
...
- Invia riepilogo automatico all'owner admin su Telegram DM (mai WhatsApp) quando un cliente contatta e quando la conversazione risulta chiusa.
